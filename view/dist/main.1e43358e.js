...
var VueSweetalert2 = function () {
  ...
  VueSweetalert2.install = function (vue, options) {
    ...
    var swalLocalInstance = _sweetalert.default.mixin(options);
    ...
    Object.assign(swalFunction, _sweetalert.default);
    var methodName;
...
exports.default = _default;
},{"sweetalert2/dist/sweetalert2.js":"node_modules/sweetalert2/dist/sweetalert2.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
if (typeof window !== 'undefined') {
    ...
    addCategory: function addCategory() {
      ...
      Swal.fire({
        ...
        preConfirm: function preConfirm() {
          var title = Swal.getPopup().querySelector("#title_category").value;
        ...
        return (0, _axios.default)({
          method: "POST",
          url: "".concat(_this.baseUrl, "/categories"),
          data: {
...
exports.default = _default;
        var $4f278a = exports.default || module.exports;
      
      if (typeof $4f278a === 'function') {
        $4f278a = $4f278a.options;
      }
    
        /* template */
        Object.assign($4f278a, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "nav",
    {
      staticClass: "navbar navbar-expand-lg navbar-light shadow-lg mb-4",
      staticStyle: { "background-color": "#f1c40f" }
    },
    [
      _c("img", {
        staticClass: "src",
        attrs: {
          src: "/kanbanboard_120442.f307eb5c.png",
          alt: "",
          width: "50px"
        }
      }),
      ...
      _c(
        "div",
        { staticClass: "container-fluid d-flex flex-row justify-content-end" },
        [
          _c("div", { staticClass: "row" }, [
            _c(
              ...
              {
                staticClass:
                  "d-flex flex-column justify-content-sm-evenly align-items-center"
              },
              [
                _vm._m(0),
                _vm._v(" "),
                _c(
                  ...
                  [
                    _c(
                      "ul",
                      { staticClass: "navbar-nav me-auto mb-2 mb-lg-0 d-flex" },
                      [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4f278a', $4f278a);
          } else {
            api.reload('$4f278a', $4f278a);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./img\\kanbanboard_120442.png":[["kanbanboard_120442.f307eb5c.png","src/components/img/kanbanboard_120442.png"],"src/components/img/kanbanboard_120442.png"],"_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Task.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    deleteTask: function deleteTask() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          return (0, _axios.default)({
            method: "DELETE",
            url: "".concat(_this.baseUrl, "/task/").concat(_this.task.id),
            headers: {
              token: localStorage.access_token
            }
          });
        } else {
          throw 'cancel'; // Swal.fire({
          //   title: "Cancel Confirm",
          // });
        }
      }).then(function () {
        _this.$emit("emitFetchDataCategory");
      }).then(function () {
        ...
        if (err === 'cancel') {
          ...
          Swal.fire({
            icon: "error",
            title: "Oops....",
            text: "".concat(err.response.data.errors)
          });
        }
    ...
    editTask: function editTask() {
      ...
      (0, _axios.default)({
        method: "GET",
        url: "".concat(this.baseUrl, "/task/").concat(this.task.id),
        headers: {
          token: localStorage.access_token
        }
      }).then(function (response) {
        console.log("ini hasil response sukses", response); //   console.log("kalau ini dari allcategory",this.allCategory.data.title);

        return Swal.fire({
          title: "Update Task",
          html: "\n            <label class=\"margin-left\">Title:</label>\n            <input type=\"text\" id=\"title_task\" class=\"swal2-input\" value=\"".concat(response.data.title, "\">\n            <label class=\"margin-left\">Description:</label>\n  <input type=\"text-area\" id=\"description_task\" class=\"swal2-input\" value=\"").concat(response.data.description, "\">\n  <label class=\"margin-left\">Category:</label><br>\n              <select type=\"text-area\" id=\"category_task\" class=\"form-control\">").concat(_this2.allCategory.map(function (category) {
            return "<option  value=\"".concat(category.id, "\">").concat(category.title, "</option>");
          }), "\n              </select>"),
          confirmButtonText: "Edit Task",
          focusConfirm: false,
          preConfirm: function preConfirm() {
            var title = Swal.getPopup().querySelector("#title_task").value;
            var description = Swal.getPopup().querySelector("#description_task").value;
            var category = Swal.getPopup().querySelector("#category_task").value;

            if (!title || !description || !category) {
              Swal.showValidationMessage("Please enter title, description and category");
            }
        ...
        console.log("<<<<<<<<<<<<<<<<<<<<<<<<<<<<", result);
        console.log("ini task id=>", _this2.task.id, "inicategoryId=>", result.value.category);
        return (0, _axios.default)({
          method: "PUT",
          url: "".concat(_this2.baseUrl, "/task/").concat(_this2.task.id),
          data: {
            title: result.value.title,
        ...
        _this2.$emit("emitFetchDataCategory");
      }).catch(function (err) {
        console.log(err);
        Swal.fire({
          icon: "error",
...
exports.default = _default;
        var $e10f83 = exports.default || module.exports;
      
      if (typeof $e10f83 === 'function') {
        $e10f83 = $e10f83.options;
      }
    
        /* template */
        Object.assign($e10f83, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "div",
    { staticClass: "card mt-2", staticStyle: { width: "14rem" } },
    [
      _c(
        "div",
      ...
      _c("div", { staticClass: "card-body" }, [
        ...
        _vm._v(" "),
        _c("p", { staticClass: "card-text" }, [
          _vm._v("created: " + _vm._s(_vm.task.createdAt.split("T")[0]))
        ]),
        _vm._v(" "),
        _c(
          "a",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e10f83', $e10f83);
          } else {
            api.reload('$e10f83', $e10f83);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    fetchDataCategory: function fetchDataCategory() {
...
exports.default = _default;
        var $dbe724 = exports.default || module.exports;
      
      if (typeof $dbe724 === 'function') {
        $dbe724 = $dbe724.options;
      }
    
        /* template */
        Object.assign($dbe724, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    {
      staticClass:
        "card bg-info mr-5 mt-3 d-flex flex-column justify-content-between align-items-center"
    },
    [
      _c(
        "div",
        {
          staticClass:
            "d-flex flex-row justify-content-xxl-between align-item-center"
        },
        [
          _c("div", { staticClass: "text-white px-4" }, [
            _c("h2", [
        ...
        _vm._l(_vm.category.Tasks, function(task) {
          return _c("Task", {
            ...
            attrs: {
              task: task,
              baseUrl: _vm.baseUrl,
              allCategory: _vm.allCategory
            },
            on: {
              emitFetchDataCategory: _vm.fetchDataCategory,
              emitDeleteTask: _vm.deleteTask
            }
          })
        }),
        1
      ...
      _c(
        "a",
        {
          staticClass: "btn btn-success d-flex align-item-center mb-2 mt-3",
          attrs: { href: "#" },
          on: {
            click: function($event) {
              $event.preventDefault()
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dbe724', $dbe724);
          } else {
            api.reload('$dbe724', $dbe724);
          }
        }
...
},{"../components/Task":"src/components/Task.vue","../components/navbar":"src/components/navbar.vue","axios":"node_modules/axios/index.js","_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/task.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $9a9590 = exports.default || module.exports;
      
      if (typeof $9a9590 === 'function') {
        $9a9590 = $9a9590.options;
      }
    
        /* template */
        Object.assign($9a9590, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9a9590', $9a9590);
          } else {
            api.reload('$9a9590', $9a9590);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    fetchCategory: function fetchCategory() {
      ...
      (0, _axios.default)({
        method: "GET",
        url: "".concat(this.baseUrl, "/categories"),
        //endpoint diganti plural
        headers: {
          token: localStorage.access_token
        }
      }).then(function (_ref) {
    ...
    deleteCategory: function deleteCategory(value) {
      ...
      (0, _axios.default)({
        method: "DELETE",
        url: "".concat(this.baseUrl, "/categories/").concat(value),
        headers: {
          token: localStorage.access_token
        }
      }).then(function (_ref2) {
...
exports.default = _default;
        var $522a4c = exports.default || module.exports;
      
      if (typeof $522a4c === 'function') {
        $522a4c = $522a4c.options;
      }
    
        /* template */
        Object.assign($522a4c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c("Navbar", {
        ...
        on: { emitFetchCategory: _vm.fetchCategory, emitLogOut: _vm.logOut }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "container" }, [
        _c("h1", { staticClass: "d-flex flex-row justify-content-center" }, [
          _vm._v("Your Personalize Kanban")
        ]),
        _vm._v(" "),
        _c("hr"),
        _vm._v(" "),
          ...
          _vm._l(_vm.categories, function(category) {
            return _c("Category", {
              ...
              attrs: {
                category: category,
                baseUrl: _vm.baseUrl,
                allCategory: _vm.categories
              },
              on: {
                emitDelCategory: _vm.deleteCategory,
                emitFetchCategory: _vm.fetchCategory,
                fetchDataCategory: _vm.fetchCategory,
                deleteTaskInCategory: _vm.fetchCategory
              }
            })
          }),
          1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$522a4c', $522a4c);
          } else {
            api.reload('$522a4c', $522a4c);
          }
        }
...
var _default = {
  ...
  methods: {
    onSuccess: function onSuccess(googleUser) {
      ...
      var id_token = googleUser.uc.id_token;
      console.log(id_token);
      (0, _axios.default)({
        method: "POST",
        url: "".concat(this.baseUrl, "/google"),
        data: {
    ...
    login: function login() {
      ...
      (0, _axios.default)({
        ...
        _this2.login_email = "";
        _this2.login_password = ""; //   localStorage.clear()
      });
    },
...
exports.default = _default;
        var $90983c = exports.default || module.exports;
      
      if (typeof $90983c === 'function') {
        $90983c = $90983c.options;
      }
    
        /* template */
        Object.assign($90983c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
        ...
        [
          _c(
            "div",
            {
              ...
              staticStyle: { "background-color": "#457b9d" }
            },
            [
              _c("article", { staticClass: "card-body" }, [
                _c(
                  "h4",
                  {
                    staticClass: "card-title text-center mb-4 mt-1 text-white"
                  },
                  [_vm._v("Login")]
                ),
                _vm._v(" "),
                  ...
                  [
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      _c(
                        "button",
                        {
                          staticClass: "btn btn-primary btn-block mb-0",
                          attrs: { type: "submit" }
                        },
                        [_vm._v("\n                Login\n              ")]
                      ),
                      _vm._v(" "),
                      _c("p", { staticClass: "text-center fs-1" }, [
                        _c(
                          "a",
                          {
                            staticClass: "btn fs-1",
                            on: {
                              click: function($event) {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$90983c', $90983c);
          } else {
            api.reload('$90983c', $90983c);
          }
        }
...
},{"axios":"node_modules/axios/index.js","vue-sweetalert2":"node_modules/vue-sweetalert2/dist/index.js","vue-google-login":"node_modules/vue-google-login/dist/vue-google-login.min.js","_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/views/Register.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    register: function register() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit("emitChangePage", "login");
      }).catch(function (err) {
        console.log(err);
        Swal.fire({
          icon: "error",
...
exports.default = _default;
        var $5704d2 = exports.default || module.exports;
      
      if (typeof $5704d2 === 'function') {
        $5704d2 = $5704d2.options;
      }
    
        /* template */
        Object.assign($5704d2, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5704d2', $5704d2);
          } else {
            api.reload('$5704d2', $5704d2);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/App.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  components: {
    ...
    Register: _Register.default // Navbar,
    // AddCategory
  ...
  methods: {
    ...
    auth: function auth() {
      ...
      _vue.default.GoogleAuth.then(function (auth2) {
...
exports.default = _default;
        var $dc85e7 = exports.default || module.exports;
      
      if (typeof $dc85e7 === 'function') {
        $dc85e7 = $dc85e7.options;
      }
    
        /* template */
        Object.assign($dc85e7, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.page === "home"
        ? _c("Home", {
            attrs: { baseUrl: _vm.url },
            on: { emitAuthenticate: _vm.auth }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.page === "login"
        ? _c("Login", {
            attrs: { baseUrl: _vm.url },
            on: { emitChangePage: _vm.changePage }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.page === "register"
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dc85e7', $dc85e7);
          } else {
            api.reload('$dc85e7', $dc85e7);
          }
        }
...
},{"./views/Home":"src/views/Home.vue","./views/Login":"src/views/Login.vue","./views/Register":"src/views/Register.vue","vue":"node_modules/vue/dist/vue.runtime.esm.js","_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"node_modules/sweetalert2/dist/sweetalert2.min.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/bootstrap/dist/css/bootstrap.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/bootstrap-vue/dist/bootstrap-vue.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
_vue.default.use(_vueSweetalert.default); // Import Bootstrap an BootstrapVue CSS files (order is important)


_vue.default.use(_vueGoogleLogin.LoaderPlugin, {
  client_id: "382446582515-unphondongv9fuasfg9r40mq3ovg1nck.apps.googleusercontent.com"
});
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","vue-sweetalert2":"node_modules/vue-sweetalert2/dist/index.js","./App.vue":"src/App.vue","sweetalert2/dist/sweetalert2.min.css":"node_modules/sweetalert2/dist/sweetalert2.min.css","bootstrap/dist/css/bootstrap.css":"node_modules/bootstrap/dist/css/bootstrap.css","bootstrap-vue/dist/bootstrap-vue.css":"node_modules/bootstrap-vue/dist/bootstrap-vue.css","vue-google-login":"node_modules/vue-google-login/dist/vue-google-login.min.js"}],"C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/MY HP/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/main.js"], null)
